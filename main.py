...
if df.empty:
    ...
    for i in range(len(df)):
        ...
        if aktueller_monat != letzter_monat:
            ...
            anteile_bh += MONATLICHER_SPARPLAN / Scaffold = kurs_aktien
    ...
    # ==============================================================================
    st.markdown("---")
    st.markdown("<h2 style='text-align: center; color: #D4AF37;'>🌱 Das ultimative Investment: Sadaqah Jariyah</h2>", unsafe_index=True)
